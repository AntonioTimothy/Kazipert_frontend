  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      {isOpen && (
        <div 
          className={cn(
            "absolute top-full mt-2 min-w-[280px] rounded-2xl border border-amber-200/50 bg-white/95 backdrop-blur-xl shadow-2xl z-[1000] overflow-hidden",
...
function CustomDropdownItem({ 
  ...
  return (
    <div
      onClick={onClick}
      className={cn(
        "px-4 py-3 cursor-pointer transition-all duration-200 hover:bg-amber-50/80 border-b border-amber-100/30 last:border-b-0",
        className
      )}
    >
      {children}
...
function CustomDropdownLabel({ 
  ...
  return (
    <div className={cn("px-4 py-2 text-xs font-semibold text-amber-700/70 uppercase tracking-wide bg-amber-50/50 sticky top-0 z-10", className)}>
      {children}
    </div>
  )
}
...
function CustomDropdownSeparator() {
  return <div className="border-t border-amber-200/30 my-1" />
}

function ScrollableDropdownContent({ children, maxHeight = "320px" }: { children: React.ReactNode; maxHeight?: string }) {
  return (
    <div 
      className="overflow-y-auto scrollbar-thin scrollbar-thumb-amber-200 scrollbar-track-transparent"
      style={{ maxHeight }}
    >
      {children}
    </div>
  ...
  return (
    <div className="flex h-screen flex-col overflow-hidden bg-gradient-to-br from-white via-amber-50/20 to-amber-50/10">
      ...
      <div className={cn(
        ...
        {/* Enhanced Header */}
        <header className="flex h-16 items-center justify-between border-b border-amber-200/40 bg-white/90 backdrop-blur-xl px-4 lg:px-6 shadow-sm relative z-40">
              ...
              >
                <ScrollableDropdownContent maxHeight="460px">
                  ...
                  <div className="bg-red-50/30">
                    <CustomDropdownLabel className="text-red-700/70">SESSION</CustomDropdownLabel>
